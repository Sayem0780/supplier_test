...
class _BillReportState extends State<BillReport>  with WidgetsBindingObserver{
  ...
  Future<void> openBox() async {
    _box = await Hive.openBox<Order?>('billbox'); // Call searchUnsold after _box is initialized
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: const Text("Bill Report"),centerTitle: true,automaticallyImplyLeading: false,),
        body: Container(
            ...
            children: [
              ...
              Visibility(
                ...
                child: Expanded(
                    flex: 5,
                    child: PdfPreview(
                      build: (format) => bPrint.createPDF(
                          selectedReport!.itemList.toList(), 15, selectedReport!.details.name,
                          selectedReport!.details.phone, selectedReport!.details.address,
                          selectedReport!.details.prpo,selectedReport!.details.total,
                          selectedReport!.details.quantity, selectedReport!.details.code, ShopName, Address, Phone
                      ),
                    )),
              ),
            ],
